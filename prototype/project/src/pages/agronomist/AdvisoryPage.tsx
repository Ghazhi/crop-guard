...
import {
  BookOpen, Plus, Loader2, Trash2, Edit2, ChevronDown, ChevronUp, Video,
} from 'lucide-react';
...
import { FarmerTrainingSessions } from '@/components/TrainingDisplay';
    ...
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Publish weekly crop-specific guidance and view upcoming training sessions.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-sm font-bold text-gray-900">Upcoming Training Sessions</h2>
        </div>
        <FarmerTrainingSessions farmerCrop={null} />
      </div>
