...
export default function CreditsInterventionsPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      ...
      <Drawer open={dialogOpen} onClose={() => setDialogOpen(false)} title={editing ? 'Edit Opportunity' : 'New Opportunity'} width="max-w-2xl">
      ...
      <Drawer open={deleteOpen} onClose={() => setDeleteOpen(false)} title="Delete Opportunity">
        <div className="space-y-4">
