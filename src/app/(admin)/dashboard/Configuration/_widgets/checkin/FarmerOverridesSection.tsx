...
import { PROGRAM_LIST } from '../../_logics/checkinConfig'
...
export function FarmerOverridesSection() {
  const [pausedIds, setPausedIds] = usePersistedState<string[]>('checkin-paused-farmers', [])
