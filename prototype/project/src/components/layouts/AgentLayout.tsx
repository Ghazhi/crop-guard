...
import { Home, Users, ClipboardCheck, FileText, Leaf, Bell, WifiOff, LogOut, UserCog, Award } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { to: '/agent/scores',   icon: Award,          label: 'Scores'   },
...
export default function AgentLayout() {
  ...
  return (
    <div className="min-h-screen bg-cropguard-gray flex flex-col max-w-md mx-auto relative">
            ...
            <div className="relative" ref={menuRef}>
              ...
              {menuOpen && (
                <div className="absolute right-0 top-9 w-48 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50">
                  ...
                  <button
                    className="w-full flex items-center gap-3 px-4 py-3 text-sm text-cropguard-forest hover:bg-cropguard-mint/50 transition-colors"
      ...
      {/* Scrollable content */}
      <main className={cn(
        'flex-1 pb-20 overflow-y-auto transition-all scrollbar-thin',
