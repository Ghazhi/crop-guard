...
import { PROGRAM_LIST } from '../../../_logics/surveyConfig'
...
export function SurveyOverrideSection() {
  const [pausedIds, setPausedIds] = usePersistedState<string[]>('survey-paused-farmers', [])
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h3 className="text-sm font-bold text-gray-900">Survey Override</h3>
          <p className="text-xs text-gray-400">Pause surveys for specific farmers within a cohort</p>
        </div>
      </div>
