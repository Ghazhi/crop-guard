/*
  ...
  All policies follow the principle of least privilege:
    - farmers: read-only on their own profile
    - agents: read their own org data, write their own records
    - staff: read/write within their organisation
    - admin: full access within their organisation
    - partner: read-only on programs they are linked to

  NOTE: No USING (true) policies are used anywhere.
*/
...
-- Agents view their assigned cohort
