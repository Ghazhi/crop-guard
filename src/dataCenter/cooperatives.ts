...
export const COOPERATIVES: Cooperative[] = [
  { id: 'coop-001', name: 'Kumasi Central Cooperative',    communityName: 'Kumasi Metro',    region: 'Ashanti',       district: 'Kumasi Metropolitan',   memberCount: 142, primaryCrops: ['Cocoa', 'Maize'],   chairmanName: 'Kwabena Owusu',   secretaryName: 'Efua Adjei',      status: 'Active',   since: '2021-03' },
